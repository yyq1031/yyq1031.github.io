...
-   `research.js`
    ...
    From this you can add your research to the web application.
    ...
    -   Add new article
        ...
        3. In the last lines you will see an array to which you need to add your new `research` function.

            ```js
            const myresearch = [article_1, article_2, article_3];
            ```
